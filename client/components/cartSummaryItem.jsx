...
function CartSummaryItem(props) {
  ...
  return (
    <div className= "row no-gutters d-flex">
      ...
      <select name="cartQty" className="col-1 cartQty align-items-center my-auto" defaultValue={props.item.count} onChange={e => onUpdate(e.currentTarget.value, props.item.id, props)}>
        <option value={props.item.count}>{props.item.count}</option>
