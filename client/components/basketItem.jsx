...
export default function basketItem(props) {
  ...
  return (
    <div className="basketBox container">
      <div className="row">
        <div className="col-3 p-0 productImg">
          <img src={cart.image} className="basketImage" />
        </div>
        <div className='col-8 p-0 productDetail'>
        ...
        <div className="col-1 text-center p-0 productDelete">
