...
![raw products output](assets/be04_1.png)
...
1. submit a pull request for this version
    * OUTPUT
1. ideally we send a 404 response when we can't find something requested.  Right now we always send 500 with our errors.
1. in your functions.php, in your error_handler
    * add another parameter, called code
    * make it a default value of 500 (this works exactly like JS es6)
1. use the code passed in as the status code you send out
1. in your products.php, in your exception for invalid ID, pass in a second parameter into the exception of 404